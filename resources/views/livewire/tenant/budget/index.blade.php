                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="inline-flex gap-x-2">
                                <a href="{{ route('tenant.budget.create') }}"
                                                                ...
                                                                <td class="px-6 py-3 text-right">
                                                                    <div class="flex items-center justify-end gap-2">
                                                                        ...
                                                                        <a title="{{ __('Items') }}"
                                                                            ...
                                                                            href="{{ route('tenant.budget.item.show', $row->id) }}">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                                        ...
                                                                        <a title="{{ __('Entry') }}"
                                                                            class="inline-flex items-center justify-center w-[46px] h-[46px] rounded-full border-4 border-gray-50 bg-gray-200 text-gray-800 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
                                                                            href="{{ route('tenant.entry.budget.listing', $row->id) }}">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                        ...
                                                                        <a title="{{ __('Edit') }}"
                                                                            class="inline-flex items-center justify-center w-[46px] h-[46px] rounded-full border-4 border-gray-50 bg-gray-200 text-gray-800 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
                                                                            href="{{ route('tenant.budget.edit', $row->id) }}">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                                                <path stroke-linecap="round" stroke-linejoin="round"
