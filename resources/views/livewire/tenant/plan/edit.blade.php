        ...
        <div class="bg-white rounded-xl shadow-xs p-4 sm:p-7 dark:bg-neutral-800">
            ...
            <form wire:submit.prevent="update">
                <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-9">
                        <input wire:model="slug" id="slug" type="text" placeholder="plan-basic"
                            class="py-1.5 px-3 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg
                        focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
                    ...
                    <div class="sm:col-span-12 flex flex-wrap gap-6 mt-4">
                        <label class="flex items-center space-x-2">
                            <input wire:model="highlighted" type="checkbox"
                    ...
                    <div class="sm:col-span-9">
                        <input wire:model="public_id" id="public_id" type="text" readonly class="py-1.5 px-3 block w-full border-gray-200 bg-gray-50 shadow-2xs sm:text-sm rounded-lg
                ...
                <div class="mt-5 flex justify-end gap-x-2">
                    <a href="{{ route('tenant.plan.index') }}"
