            ...
            <div class="bg-white rounded-xl shadow-xs p-4 sm:p-7 dark:bg-neutral-800">
                ...
                <form wire:submit.prevent="sendEmail">
                    <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                        ...
                        <div class="sm:col-span-10">
                            <input wire:model="recipient_email" id="recipient_email" type="email" step="0.01"
                                placeholder="{{ __('Email customer') }}"
                                class="py-1.5 px-3 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg
                                   focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
                        ...
                        <div class="sm:col-span-10">
                            <input wire:model="additional_emails" id="additional_emails" type="text" step="0.01"
                                placeholder="{{ __('email1@email.com, email2@gmail.com') }}"
                                class="py-1.5 px-3 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg
                                   focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
                            @error('additional_emails') <span class="text-sm text-red-600">{{ $message }}</span>
                            @enderror
                        </div>
