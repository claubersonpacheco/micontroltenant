                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-neutral-400">
                                    {{ __("Manage your services") }}
                                </p>
                            </div>

                            <div class="inline-flex gap-x-2">
                                <a href="{{ route('tenant.product.create') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-3 text-right">
                                            ...
                                            <a title="Editar"
                                                ...
                                                href="{{ route('tenant.product.edit', $row->id) }}">
                                                <!-- Icon -->
                                                <span
                                            ...
                                            <!-- Delete -->
                                            <livewire:tenant.product.delete :product="$row" :key="uniqid('', true)"
                                                                             @deleted="$refresh"/>
                                            </div>
                                        </td>
                                    </tr>
