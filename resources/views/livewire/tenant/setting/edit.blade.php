        ...
        <div class="bg-white rounded-xl shadow-xs p-4 sm:p-7 dark:bg-neutral-800">
            ...
            <form wire:submit.prevent="update">
                <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                    ...
                    <!-- Website -->
                    <div class="sm:col-span-3">
                        <label for="website" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-neutral-200">
                            {{ __('Web Site') }}
                        </label>
                    </div>
                    <div class="sm:col-span-9">
                        <input wire:model="settings.website" id="website" type="text" placeholder="Website"
                            class="py-1.5 px-3 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
                        @error('settings.website') <span class="text-sm text-red-600">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="sm:col-span-9">
                        <input wire:model="settings.document" id="document" type="text"
                    ...
                    <div class="sm:col-span-9">
                        <input wire:model="settings.postal_code" id="postal_code" type="text"
                            placeholder="Enter postal code"
                            class="py-1.5 px-3 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
                        @error('settings.postal_code') <span class="text-sm text-red-600">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="sm:col-span-9">
                        <input wire:model="settings.send_email" id="send_email" type="text"
                    ...
                    <div class="sm:col-span-9">
                        <textarea wire:model="settings.description" id="description" type="text"
                            class="py-1.5 px-3 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
                        </textarea>
                    ...
                    <div class="sm:col-span-9">
                        <input wire:model="settings.keywords" id="keywords" type="text" placeholder="Keywords"
                            class="py-1.5 px-3 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
                    ...
                    <div class="sm:col-span-9">
                        <input wire:model="settings.author" id="author" type="text" placeholder="Author"
                            class="py-1.5 px-3 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
                    ...
                    <div class="sm:col-span-9">
                        <select wire:model="settings.locale" id="locale" class="py-1.5 px-3 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg
                ...
                <div class="mt-5 flex justify-end gap-x-2">
                    <a href="{{ route('tenant.setting.index') }}" type="button"
