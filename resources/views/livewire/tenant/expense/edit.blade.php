                ...
                <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                    ...
                    <template x-if="$wire.invoice == 1">
                        <div class="contents">
                            <!-- Invoice Number -->
                            <div class="sm:col-span-2">
                                <label for="invoice_number" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-neutral-200">
                                    {{ __('Invoice Number') }}
                                </label>
                            </div>
                            <div class="sm:col-span-2">
                                <input wire:model="invoice_number" id="invoice_number" type="text" placeholder="{{ __('Invoice Number') }}"
                                       class="py-1.5 px-3 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg
                   focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
