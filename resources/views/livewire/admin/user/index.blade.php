                                            ...
                                            <div class="flex items-center gap-x-3">
                                                @if($data->photo_path)
                                                    <img class="inline-block w-[38px] h-[38px] rounded-full object-cover"
                                                         src="{{ asset('storage/' . $data->photo_path) }}"
                                                         alt="{{ $data->name }}">
                                                @else
                                                    <span class="inline-block w-[46px] h-[46px] bg-gray-100 rounded-full overflow-hidden">
                                                        <svg class="w-full h-full text-gray-300" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
