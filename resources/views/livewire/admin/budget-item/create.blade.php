<div>
    ...
    <div
        x-data="{ open: false }"
        x-on:open-modal.window="if($event.detail.name === 'create-item') open = true"
        x-on:close-modal.window="if($event.detail.name === 'create-item') open = false"
        x-show="open"
        x-cloak
    ...
    >
        <!--modal-->
        <div x-show="open" class="fixed inset-0 z-[99] flex items-center justify-center bg-gray-500 bg-opacity-10" style="background-color: rgba(107, 114, 128, 0.5);">
            <div class="sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                <div class="flex flex-col bg-white border border-gray-200 shadow-2xs rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
                    ...
                    <form id="customer-create" wire:submit.prevent="insertItem">
                        <div class="p-4 overflow-y-auto">
                            ...
                            <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                                ...
                                <div class="sm:col-span-9">
                                    <input wire:model="taxValue" id="taxValue" type="text" readonly
                                           class="py-1.5 px-3 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg
                                  focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
