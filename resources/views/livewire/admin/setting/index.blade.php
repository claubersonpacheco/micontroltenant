                    ...
                    <div class="bg-white border border-gray-200 rounded-xl shadow-2xs overflow-hidden dark:bg-neutral-800 dark:border-neutral-700">
                        ...
                        <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
                            ...
                            <div class="inline-flex gap-x-2">
                                <a href="{{ route('setting.create') }}" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-semibold uppercase text-gray-800 dark:text-neutral-200">E-mail</th>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-3 text-right">
                                        <a title="Editar"
                                           ...
                                           href="{{ route('setting.edit', $row->id) }}">
                                            <!-- Icon -->
                                            <span
