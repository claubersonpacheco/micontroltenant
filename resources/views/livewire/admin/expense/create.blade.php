        ...
        <div class="bg-white rounded-xl shadow-xs p-4 sm:p-7 dark:bg-neutral-800">
            ...
            <form wire:submit.prevent="store">
                <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                    ...
                    <!-- Methodo Pay -->
                    <div class="sm:col-span-2">
                        <label for="method_pay" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-neutral-200">
                            {{ __('Method Pay') }}
                        </label>
                    </div>
                    <div class="sm:col-span-10 flex gap-2 items-center">
                        <!-- Select da categoria -->
                        <select wire:model="method_pay" id="method_pay"
                                class="flex-1 py-1.5 px-3 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg
                                    focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
                    ...
                    <template x-if="$wire.invoice == 1">
                        ...
                        <!-- Invoice Number -->
                        <div class="sm:col-span-2">
                            <label for="invoice_path" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-neutral-200">
                                {{ __('File Invoice') }}
                            </label>
                        </div>
                        <div class="sm:col-span-3">
                            <input wire:model="invoice_path" id="invoice_path" type="file" class="block w-full text-sm text-gray-500
                              ...
                              ">
                            @error('invoice_path') <span class="text-sm text-red-600">{{ $message }}</span> @enderror
                        </div>
                        </div>
                    </template>
