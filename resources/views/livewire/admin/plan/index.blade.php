                        ...
                        <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-neutral-400">
                                    {{ __("Manage your plans") }}
                                </p>
                            </div>

                            <div class="inline-flex gap-x-2">
                                <a href="{{ route('admin.plan.create') }}" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-3 text-right">
                                        <a title="Editar"
                                           ...
                                           href="{{ route('admin.plan.edit', $row->id) }}">
                                            <!-- Icon -->
                                            <span
                                        ...
                                        <a title="Delete"
                                           wire:click="$dispatch('open-modal', { name: 'delete-plan', id: '{{ $row->id }}' })"
                                           class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
