                            ...
                            @forelse($rows as $data)
                                <tr>
                                    ...
                                    <td class="h-px w-72 whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200"> <a href="https://{{ $data->domains()->first()->domain }}" target="_blank">{{ $data->domains()->first()->domain }}</a></span>
                                    ...
                                    <td class="px-6 py-3 text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            <a title="Editar"
                                               ...
                                               href="{{ route('tenant.edit', $data->id) }}">
                                                <!-- Icon -->
                                                <span
                                            ...
                                            <!-- Delete -->
                                            <livewire:admin.tenant.delete :tenant="$data" :key="uniqid('', true)"
                                                                             @deleted="$refresh"/>
