...
<a title="Delete"
   wire:click="$dispatch('open-modal', { name: @js($name) }); $dispatch(@js($name), { id: @js($id) })"
   class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 cursor-pointer">
